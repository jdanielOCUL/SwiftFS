...
exports = module.exports = function serveIndex(swift, root, options){
  options = options || {};
  ...
  return function serveIndex(req, res, next) {
    ...
    swift.stat(path, function(err, stat){
      ...
      if(stat.isDirectory())
        swift.readdir(path, function(err, files){
        ...
        {
        res.setHeader('Content-Length', stat.file.size);
        swift.read(path, res);
        }
    });
  };
